...
export default function HeroEvent(){
    return(
        <div className="flex flex-col  bg-gradient-to-r from-blue-50 to-yellow-50 items-center justify-center text-center gap-8 py-20">
            <span className="bg-blue-100  text-blue-600 border border-1 border-blue-300 py-2 px-5 rounded-md text-sm font-semibold">Agenda</span>
            <h1>
            ...
            <div className="flex gap-4">
                ...
                <Button className="bg-white rounded-sm border border-2 border-green-600 hover:bg-green-300">
