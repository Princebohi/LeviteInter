...
export default function Partners(){
    return(
            <div className="flex flex-col gap-10 px-30">
                ...
                <div className=" flex flex-col text-center">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 py-8 ">
                        <p className="bg-blue-50 border border-2 max-w-sm border-gray-200 rounded-lg py-2">CHU de Cocody</p>
                        <p className="bg-blue-50 border border-2 max-w-sm border-gray-200 rounded-lg py-2">Hôpital Général de Bingerville</p>
                        <p className="bg-blue-50 border border-2 max-w-sm border-gray-200 rounded-lg py-2">Centre de Santé de Yopougon</p>
                        <p className="bg-blue-50 border border-2 max-w-sm border-gray-200 rounded-lg py-2">Clinique Internationnale</p>
                        <p className="bg-blue-50 border border-2 max-w-sm border-gray-200 rounded-lg py-2">Laboratoire CERBA</p>
                        <p className="bg-blue-50 border border-2 max-w-sm border-gray-200 rounded-lg py-2">Centre Médical Saint-Joseph</p>
                        <p className="bg-blue-50 border border-2 max-w-sm border-gray-200 rounded-lg py-2">Polyclinique Saint-Anne-Marie</p>
                        <p className="bg-blue-50 border border-2 max-w-sm border-gray-200 rounded-lg py-2">Hôpital Méthodiste de Dabou</p>
                    </div>
                    <hr className="w-full border-gray-400" />
                </div>
                ...
                <div className=" flex flex-col text-center">
                    <h2 className="text-blue-900 text-2xl font-bold">Partenaires Santé</h2>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 py-8 ">
                        <div className="bg-blue-50 border border-2 px-3 border-gray-200 rounded-lg py-2">
