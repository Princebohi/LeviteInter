...
export default function HeroBlog(){
    return(
        <div className="flex flex-col  bg-gradient-to-r px-5 from-yellow-50 to-blue-50 items-center justify-center text-center gap-8 py-20">
            <span className="bg-orange-100  text-orange-400  border-1 border-orange-200 py-2 px-5 rounded-md text-sm font-semibold">Blog et actualités</span>
            <h1>
